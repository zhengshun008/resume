...
/***/ function(module, exports, __webpack_require__) {
	...
	var SwiperAmnimate=__webpack_require__(3);

	var mySwiper = new Swiper ('.swiper-container', {
	  onInit: function(swiper){ //Swiper2.x的初始化是onFirstInit
	   SwiperAmnimate.swiperAnimateCache(swiper); //隐藏动画元素 
	    SwiperAmnimate.swiperAnimate(swiper); //初始化完成开始动画
	  }, 
	  onSlideChangeEnd: function(swiper){ 
	    SwiperAmnimate.swiperAnimate(swiper); //每个slide切换结束时也运行当前slide动画 
	  } 
	  });  
